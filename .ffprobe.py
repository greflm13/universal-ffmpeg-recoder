...
def ffprobe_from_dict(s: Any) -> List[Ffprobe]:
    return from_list(Ffprobe.from_dict, s)


def ffprobe_to_dict(x: List[Ffprobe]) -> Any:
    return from_list(lambda x: to_class(Ffprobe, x), x)
